...
;   Segment VIDEO_DATA
;---------------------------------
.export VIDEORAM_BUFFER
.export VIDEORAM_BUFFER_SIZE
...
; Used to initialize sysdata with $00
ZP_CLEAR_PTR:               .res 1           ; Pointer zum Initialisieren des sysdata mit $00
...
ZP_KEYB_IS_NUMLOCK:         .res 1           ; indicator if NUMLOCK key was pressed (1) or released (0)
...
KEYB_BUFFER:           .res $10         ; max size 16 ($10) byte
...
VIDEORAM_BUFFER:       .res $1000       ; size 4096 byte, 4kB
VIDEORAM_BUFFER_SIZE = * -VIDEORAM_BUFFER
